  ...
  return (
    <div className="mb-5">
      <div className="flex items-center gap-2 text-white mb-3">
        ...
        <span className="text-white/80 text-[10px] font-bold">· from interview</span>
      </div>
        ...
        {insights.map((note, i) => {
          ...
          return (
            <motion.div
              ...
              className={`${s.bg} ${s.text} w-[calc(50%-0.4rem)] sm:w-40 rounded-[24px] px-4 pt-4 pb-3 shadow-[0_8px_30px_rgb(0,0,0,0.06)] border border-white relative`}
            ...
            >
              ...
              <p className="text-xs font-black leading-snug tracking-tight">{note.text}</p>
              <p className={`text-[9px] uppercase tracking-wider font-extrabold mt-2.5 ${s.labelColor}`}>{s.label}</p>
            </motion.div>
          );
        })}
      </div>
