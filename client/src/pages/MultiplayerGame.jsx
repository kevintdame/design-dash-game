            ...
            >
              ...
              <Card className="bg-card text-card-foreground border border-slate-200/5 shadow-lg rounded-2xl ring-1 ring-black/5">
                ...
                <CardContent className="pb-5">
                  <Input 
                    ...
                    className="bg-white border-slate-200 text-[#20262e] placeholder:text-slate-400 focus:border-accent focus-visible:ring-0 focus-visible:ring-offset-0 rounded-xl h-12 text-sm"
                  />
                </CardContent>
              </Card>
              ...
              <Tabs defaultValue="create" className="w-full">
                <TabsList className="grid w-full grid-cols-2 bg-slate-800 text-slate-400 rounded-xl h-12 p-1">
                  <TabsTrigger 
                    value="create" 
                    className="rounded-lg font-bold text-xs transition data-[state=active]:bg-accent data-[state=active]:text-white text-slate-450"
                  >
                    Create Room
                  </TabsTrigger>
                  <TabsTrigger 
                  ...
                  <Card className="bg-card text-card-foreground border border-slate-200/5 shadow-lg rounded-2xl ring-1 ring-black/5">
                    <CardContent className="pt-5 pb-5">
                      <Button 
                        ...
                        className="w-full bg-accent hover:bg-accent/90 text-white font-bold h-12 rounded-lg shadow-md transition-transform active:scale-[0.98]"
                      >
                    ...
                    <CardContent className="space-y-4 pt-5 pb-5">
                      <div className="space-y-1.5">
                        ...
                        <Input 
                          ...
                          className="bg-white border-slate-200 text-[#20262e] placeholder:text-slate-450 focus:border-accent focus-visible:ring-0 focus-visible:ring-offset-0 uppercase tracking-widest text-center text-lg font-bold rounded-xl h-12"
                          maxLength={4}
                        />
                      </div>
                      <Button 
          ...
          {mode === "lobby" && room && (
            ...
            >
              <Card className="bg-card text-card-foreground border border-slate-200/5 shadow-lg rounded-2xl ring-1 ring-black/5 text-center">
                <CardHeader className="pb-3">
                  <span className="text-xs uppercase font-semibold tracking-wider text-accent">Room Code</span>
